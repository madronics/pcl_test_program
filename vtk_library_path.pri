#win32:CONFIG(release, debug|release): LIBS += -L'C:\Program Files\PCL 1.11.1\3rdParty\VTK\lib\' -lvtkChartsCore-8.2 \
LIBS += -L'C:\Program Files\PCL 1.11.1\3rdParty\VTK\lib' -lvtkChartsCore-8.2 \
    -lvtkCommonColor-8.2 \
...
INCLUDEPATH += 'C:\Program Files\PCL 1.11.1\3rdParty\VTK\include\vtk-8.2'
DEPENDPATH += 'C:\Program Files\PCL 1.11.1\3rdParty\VTK\include\vtk-8.2'
